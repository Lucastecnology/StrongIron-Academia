...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (imcForm) {
    imcForm.addEventListener("submit", (e) => {
      ...
      let imcLevel = "";
      if (imc < 18.5) imcLevel = "Baixo Peso";
      else if (imc >= 18.5 && imc <= 24.9) imcLevel = "Peso Normal";
      else if (imc >= 25 && imc <= 29.9) imcLevel = "Excesso de Peso";
      else if (imc >= 30 && imc <= 35) imcLevel = "Obesidade";
      else imcLevel = "Obesidade Extrema";
      document.getElementById("imc-result").innerText = `Seu IMC é: ${imc} - ${imcLevel}`;
    });
  }
